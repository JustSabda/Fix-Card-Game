...
public class CardDataBase : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        cardList.Add(new Card(0, "Cecep", 1 , 1, "None",Resources.Load<Sprite>("Kian Santang"),0,1,1,1));
        cardList.Add(new Card(1, "Semprul", 2, 5, "None", Resources.Load<Sprite>("Sutawijaya"),0,1,1,1));
        cardList.Add(new Card(2, "Bambang", 1, 1, "None",Resources.Load<Sprite>("Sultan Agung"),0,1,1,1));
